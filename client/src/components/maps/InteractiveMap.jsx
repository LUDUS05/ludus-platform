    ...
    const initMap = async () => {
      try {
        ...
        const map = new Map(mapRef.current, {
          center,
          zoom,
          mapId: 'ludus-map', // Required for Advanced Markers
          styles: [
            {
              featureType: 'poi',
              elementType: 'labels',
    ...
    const updateMarkers = async () => {
      try {
        ...
        events.forEach(event => {
          ...
          markersRef.current.set(event._id, marker);
        });
      ...
      <div class="p-3 max-w-xs">
        <div class="flex items-start space-x-3">
          <div class="flex-shrink-0">
            <div class="w-12 h-12 bg-ludus-orange rounded-lg flex items-center justify-center">
