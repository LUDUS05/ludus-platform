    ...
    <div className="social-login-container">
      <style>
        {`
          ...
          /* Center single button when only Google is enabled */
      ...
      <div className="social-buttons">
        {/* Google Login - Only enabled social login */}
        <button
        ...
        {/* Temporarily disabled social logins */}
        {/* 
        <button
          onClick={() => {
      ...
      <div className="social-hint">
        {t('auth.socialHint', 'Quick and secure sign-in with Google')}
      </div>
    </div>
  );
};
