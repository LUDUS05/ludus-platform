      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-center space-x-4">
            <div className={`flex items-center ${step >= 1 ? 'text-ludus-orange' : 'text-gray-400'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center ${step >= 1 ? 'bg-ludus-orange text-white' : 'bg-gray-300'}`}>
                1
              </div>
              <span className="ml-2 font-medium">Booking Details</span>
            </div>
            <div className={`w-16 h-1 ${step >= 2 ? 'bg-ludus-orange' : 'bg-gray-300'}`}></div>
            <div className={`flex items-center ${step >= 2 ? 'text-ludus-orange' : 'text-gray-400'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center ${step >= 2 ? 'bg-ludus-orange text-white' : 'bg-gray-300'}`}>
                2
              </div>
                    ...
                    <div className="border-t border-gray-200 pt-6">
                      <div className="flex items-start">
                        <input
                          ...
                          className="w-4 h-4 text-ludus-orange border-gray-300 rounded focus:ring-ludus-orange/50 mt-1"
                        />
                ...
                <div className="space-y-4">
                  ...
                  {step === 2 && (
                    <div className="border-t border-gray-200 pt-4">
                      <button
                        onClick={() => setStep(1)}
                        className="w-full text-ludus-orange hover:text-ludus-orange-dark text-sm font-medium"
                      >
