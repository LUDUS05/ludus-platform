...
const Footer = () => {
  ...
  const { pages: footerPages } = useMenuPages('footer');
  ...
  return (
    <footer className="bg-transparent border-t border-white/10 text-white dark:text-dark-text-primary mt-auto relative z-20">
