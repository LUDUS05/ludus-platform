/**
 * Fix Menu Pages Script
 * Creates sample pages for header and footer navigation using direct database operations
 */

const mongoose = require('mongoose');
require('dotenv').config();

// Import the actual Page model from the server
